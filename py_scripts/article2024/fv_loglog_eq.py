...
colors = cycle(['k', 'g'])
linestyles = cycle(['-', '-', '--', '--'])
markers = cycle(['none', 'none', 'none'])  # circle, square, diamond
# simIDs = [110, 115, 113, 116]
# simLegends = [
#     r"$\tau_0 = 10^{-6}$",
#     r"$\tau_0 = 10^{-6}$, no latent heat",
#     r"$\beta = \beta_{eq}$",
#     r"$\beta = \beta_{eq}$, no latent heat"
# ]
# simIDs = [105, 106]
# simLegends = [
#     r"$\tau_0 = 10^{-6}, L^*=0$",
